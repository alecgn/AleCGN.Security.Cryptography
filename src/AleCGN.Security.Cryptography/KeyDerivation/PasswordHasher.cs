...
namespace AleCGN.Security.Cryptography.KeyDerivation
{
    ...
    public class PasswordHasher : IPasswordHasher
    {
        ...
        public Task<string> HashPasswordAsync(string password, CancellationToken cancellationToken = default)
            => Task.Run(() => HashPassword(password), cancellationToken);

        public Task<bool> VerifyPasswordAsync(string password, string hashedPassword, CancellationToken cancellationToken = default)
            => Task.Run(() => VerifyPassword(password, hashedPassword), cancellationToken);

        public Task<bool> NeedsRehashAsync(string hashedPassword, CancellationToken cancellationToken = default)
            => Task.Run(() => NeedsRehash(hashedPassword), cancellationToken);
