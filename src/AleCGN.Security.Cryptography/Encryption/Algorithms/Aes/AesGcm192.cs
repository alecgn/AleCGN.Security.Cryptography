...
namespace AleCGN.Security.Cryptography.Encryption.Algorithms.Aes
{
    public class AesGcm192 : AesGcmBase, IAesGcm192
    {
        ...
        public AesGcm192(IEncoder encoder) : base(encoder) { }

        public AesGcm192(IEncoder encoder, byte[] key) : base(encoder, ValidateAESKey(key).Invoke()) { }

        public AesGcm192(IEncoder encoder, string encodedKey) : base(encoder, ValidateAESKey(encoder.Decode(encodedKey)).Invoke()) { }
